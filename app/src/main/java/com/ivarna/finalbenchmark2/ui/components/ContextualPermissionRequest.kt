...
@Composable
fun PhoneStatePermissionRequest(
    modifier: Modifier = Modifier,
    content: @Composable () -> Unit
) {
    ContextualPermissionRequest(
        permission = Manifest.permission.READ_PHONE_STATE,
        rationaleText = "Phone permission is needed to show Network Signal strength and SIM information",
        modifier = modifier,
        content = content
    )
}
...
fun LocationPermissionRequest(
    ...
    ContextualPermissionRequest(
        ...
        rationaleText = "Location permission is needed to show WiFi SSID/BSSID and Cell Tower info",
        modifier = modifier,
        content = content
    )
}
...
@Composable
fun BodySensorsPermissionRequest(
    modifier: Modifier = Modifier,
    content: @Composable () -> Unit
) {
    ContextualPermissionRequest(
        permission = Manifest.permission.BODY_SENSORS,
        rationaleText = "Body sensors permission is needed to access heart rate and other sensor data",
        modifier = modifier,
        content = content
    )
}
