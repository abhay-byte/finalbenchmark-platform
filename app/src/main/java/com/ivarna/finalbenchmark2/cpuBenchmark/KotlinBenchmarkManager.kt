...
class KotlinBenchmarkManager {
    ...
    companion object {
        ...
        // FIXED: Updated Single-Core Prime Generation factor for Trial Division algorithm
        private val SINGLE_CORE_FACTORS =
                mapOf(
                        "Prime Generation" to
                                4.0e-4, // FIXED: Increased from 2.0e-5 to 4.0e-4 (20x) for Trial
                        // Division
        ...
        // Multi-core factors updated for strided loop implementation
        private val MULTI_CORE_FACTORS =
                mapOf(
                        "Prime Generation" to
                                8.0e-5, // FIXED: Increased from 6.0e-6 to 8.0e-5 for strided loop
    ...
    suspend fun runAllBenchmarks(deviceTier: String = "Flagship") {
        ...
        val singleNqueensResult =
                safeBenchmarkRun("Single-Core N-Queens") { SingleCoreBenchmarks.nqueens(params) }
        ...
        val multiNqueensResult =
                safeBenchmarkRun("Multi-Core N-Queens") { MultiCoreBenchmarks.nqueens(params) }
