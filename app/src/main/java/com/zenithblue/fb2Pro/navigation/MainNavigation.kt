...
import com.zenithblue.fb2Pro.ui.screens.DetailedResultScreen

import com.zenithblue.fb2Pro.ui.viewmodels.RootStatus
import com.zenithblue.fb2Pro.utils.OnboardingPreferences
...
fun MainNavigation(
    ...
    var showCrashDialog by remember {
        mutableStateOf(com.zenithblue.fb2Pro.CrashHandler.hasCrashReport(context))
    }
    if (showCrashDialog) {
        val crashReport = remember { com.zenithblue.fb2Pro.CrashHandler.getCrashReport(context) ?: "No details available" }
        AlertDialog(
            onDismissRequest = {},
            ...
            confirmButton = {
                TextButton(onClick = {
                    com.zenithblue.fb2Pro.CrashHandler.clearCrashReport(context)
        ...
        Box(
            ...
            NavHost(
                ...
                composable(
                    ...
                    val historyRepository =
                            com.zenithblue.fb2Pro.data.repository.HistoryRepository(
                                    com.zenithblue.fb2Pro.data.database.AppDatabase
                                            .getDatabase(context)
                                            .benchmarkDao()
                            )
                ...
                composable(
                    ...
                    val historyViewModel: com.zenithblue.fb2Pro.ui.viewmodels.HistoryViewModel =
                            viewModel(
                                    factory =
                                            com.zenithblue.fb2Pro.di.DatabaseInitializer
                ...
                composable(
                    ...
                    com.zenithblue.fb2Pro.ui.screens.FullBenchmarkLastResultScreen(
                        historyRepository = historyRepository,
                        onBackClick = { navController.popBackStack() }
                    )
                }
                ...
                composable(
                    ...
                    val category = try {
                        com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.valueOf(typeString)
                    } catch (e: Exception) {
                        com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.CPU
                    }
                    
                    // GPU benchmark gets its own dedicated rendering screen
                    if (category == com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.GPU) {
                    ...
                    } else if (category == com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.FULL) {
                        ...
                        com.zenithblue.fb2Pro.ui.screens.FullBenchmarkScreen(
                            preset = preset,
                    ...
                    } else if (category == com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.STORAGE) {
                        ...
                        com.zenithblue.fb2Pro.ui.screens.StorageBenchmarkScreen(
                            preset = preset,
                    ...
                    } else if (category == com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.RAM) {
                    ...
                    } else if (category == com.zenithblue.fb2Pro.cpuBenchmark.BenchmarkCategory.PRODUCTIVITY) {
                        ...
                        com.zenithblue.fb2Pro.ui.screens.ProductivityBenchmarkScreen(
                            preset = preset,
