package com.zenithblue.fb2Pro.data.repository
...
import com.zenithblue.fb2Pro.data.database.entities.BenchmarkWithCpuData
...
class HistoryRepository(
    ...
    suspend fun saveGenericBenchmark(
        benchmarkResult: BenchmarkResultEntity,
        genericDetails: List<com.zenithblue.fb2Pro.data.database.entities.GenericTestDetailEntity>
    ) {
