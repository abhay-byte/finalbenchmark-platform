...
import com.zenithblue.fb2Pro.utils.RootUtils
import com.zenithblue.fb2Pro.utils.RootCommandExecutor
...
import com.zenithblue.fb2Pro.navigation.MainNavigation
import com.zenithblue.fb2Pro.ui.theme.FB2ProTheme
import com.zenithblue.fb2Pro.ui.theme.LocalThemeMode
import com.zenithblue.fb2Pro.ui.theme.provideThemeMode
import com.zenithblue.fb2Pro.ui.viewmodels.MainViewModel
import com.zenithblue.fb2Pro.ui.viewmodels.RootStatus
import com.zenithblue.fb2Pro.utils.ThemePreferences
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            provideThemeMode(currentThemeMode) {
                FB2ProTheme(themeMode = currentThemeMode) {
    ...
    private fun detectCPUCoreConfiguration() {
        try {
            ...
            bigCoreCount = com.zenithblue.fb2Pro.cpuBenchmark.CpuAffinityManager.getBigCores().size
            midCoreCount = com.zenithblue.fb2Pro.cpuBenchmark.CpuAffinityManager.getMidCores().size
            littleCoreCount = com.zenithblue.fb2Pro.cpuBenchmark.CpuAffinityManager.getLittleCores().size
            ...
            if (totalCores > 0) {
                ...
                com.zenithblue.fb2Pro.cpuBenchmark.CpuAffinityManager.logTopology()
            } else {
    ...
    private fun startForegroundService() {
        try {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                isForegroundServiceActive = com.zenithblue.fb2Pro.BenchmarkForegroundService.isServiceRunning
                Log.i(TAG, "Checking foreground service status: isServiceRunning = ${com.zenithblue.fb2Pro.BenchmarkForegroundService.isServiceRunning}")
    ...
    private fun checkRootAccess(): Boolean {
        return try {
            ...
            val cachedResult = com.zenithblue.fb2Pro.utils.RootAccessManager.getCachedRootAccess()
            cachedResult ?: false
        } catch (e: Exception) {
