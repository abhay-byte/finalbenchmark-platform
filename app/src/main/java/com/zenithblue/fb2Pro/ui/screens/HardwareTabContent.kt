...
import com.zenithblue.fb2Pro.ui.components.CameraPermissionRequest
import com.zenithblue.fb2Pro.ui.components.InformationRow
import com.zenithblue.fb2Pro.ui.components.PhoneStatePermissionRequest
import com.zenithblue.fb2Pro.ui.viewmodels.HardwareViewModel
import com.zenithblue.fb2Pro.ui.components.GlassCard
...
fun HardwareTabContent(viewModel: HardwareViewModel) {
        var batterySpecs by remember {
                mutableStateOf<com.zenithblue.fb2Pro.utils.BatterySpec?>(null)
        }
        var networkSpecs by remember {
                mutableStateOf<com.zenithblue.fb2Pro.utils.NetworkSpec?>(null)
        }
        var cameraSpecs by remember {
                mutableStateOf<List<com.zenithblue.fb2Pro.utils.CameraSpec>?>(null)
        }
        var memoryStorageSpecs by remember {
                mutableStateOf<com.zenithblue.fb2Pro.utils.MemoryStorageSpec?>(null)
        }
        var audioMediaSpecs by remember {
                mutableStateOf<com.zenithblue.fb2Pro.utils.AudioMediaSpec?>(null)
        }
        var peripheralsSpecs by remember {
                mutableStateOf<com.zenithblue.fb2Pro.utils.PeripheralsSpec?>(null)
        }
        ...
        DisposableEffect(viewModel) {
                val batteryObserver =
                        Observer<com.zenithblue.fb2Pro.utils.BatterySpec?> { newValue ->
                                batterySpecs = newValue
                        }
                val networkObserver =
                        Observer<com.zenithblue.fb2Pro.utils.NetworkSpec?> { newValue ->
                                networkSpecs = newValue
                        }
                val cameraObserver =
                        Observer<List<com.zenithblue.fb2Pro.utils.CameraSpec>?> { newValue ->
                                cameraSpecs = newValue
                        }
                val memoryStorageObserver =
                        Observer<com.zenithblue.fb2Pro.utils.MemoryStorageSpec?> { newValue ->
                                memoryStorageSpecs = newValue
                        }
                val audioMediaObserver =
                        Observer<com.zenithblue.fb2Pro.utils.AudioMediaSpec?> { newValue ->
                                audioMediaSpecs = newValue
                        }
                val peripheralsObserver =
                        Observer<com.zenithblue.fb2Pro.utils.PeripheralsSpec?> { newValue ->
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BatteryCard(batterySpecs: com.zenithblue.fb2Pro.utils.BatterySpec?) {
                ...
                GlassCard(
                        ...
                        Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
                                ...
                                InformationRow(
                                        itemValue =
                                                com.zenithblue.fb2Pro.domain.model.ItemValue
                                                        .Text("Level", "${batterySpecs.level}%"),
                                        isLastItem = false
                                )
                                InformationRow(
                                        itemValue =
                                                com.zenithblue.fb2Pro.domain.model.ItemValue
                                                        .Text("Status", batterySpecs.status),
                                        isLastItem = false
                                )
                                InformationRow(
                                        itemValue =
                                ...
                                InformationRow(
                                        itemValue =
                                                com.zenithblue.fb2Pro.domain.model.ItemValue
                                                        .Text("Health", batterySpecs.health),
                                        isLastItem = false
                                )
                                InformationRow(
                                        itemValue =
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ConnectivityCard(networkSpecs: com.zenithblue.fb2Pro.utils.NetworkSpec?) {
                ...
                GlassCard(
                        ...
                        Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
                                ...
                                InformationRow(
                                        itemValue =
                                                com.zenithblue.fb2Pro.domain.model.ItemValue
                                                        .Text("WiFi Speed", networkSpecs.wifiSpeed),
                                        isLastItem = false
                                )
                                InformationRow(
                                        itemValue =
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CameraCard(cameraSpecs: List<com.zenithblue.fb2Pro.utils.CameraSpec>?) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MemoryStorageCard(memoryStorageSpecs: com.zenithblue.fb2Pro.utils.MemoryStorageSpec?) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AudioMediaCard(audioMediaSpecs: com.zenithblue.fb2Pro.utils.AudioMediaSpec?) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PeripheralsCard(peripheralsSpecs: com.zenithblue.fb2Pro.utils.PeripheralsSpec?) {
