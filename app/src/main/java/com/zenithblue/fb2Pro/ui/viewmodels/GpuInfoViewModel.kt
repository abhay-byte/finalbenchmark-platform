...
import com.zenithblue.fb2Pro.ui.components.GpuDataPoint
import com.zenithblue.fb2Pro.utils.GpuFrequencyReader
import com.zenithblue.fb2Pro.utils.GpuFrequencyFallback
...
class GpuInfoViewModel : ViewModel() {
    ...
    private val gpuFrequencyMonitor = com.zenithblue.fb2Pro.utils.GpuFrequencyMonitor(gpuFrequencyReader, viewModelScope)
